...
from planner_wbc.control.main.config_template import ArgsConfig as ArgsConfigTemplate
from planner_wbc.control.policy.wbc_policy_factory import WBC_VERSIONS
from planner_wbc.control.utils.network_utils import resolve_interface
...
class BaseConfig(ArgsConfigTemplate):
    ...
    def load_wbc_yaml(self) -> dict:
        ...
        package_path = Path(os.path.dirname(planner_wbc.__file__))
...
class PlannerConfig(BaseConfig):
    """Configuration for replaying planner joint trajectories."""

    trajectory_path: str = "control/dataset/retar_dualarm_18.npz"
    """Path relative to the planner_wbc package."""
