...
from gear_sonic_planner.planner.configs.configs import TrajectoryConfig
...
def resolve_trajectory_path(trajectory_path: str) -> Path:
    """Resolve a trajectory path relative to the planner package directory."""
...
def build_trajectory_runtime(config: TrajectoryConfig, logger) -> TrajectoryRuntime:
...
def main(config: TrajectoryConfig):
